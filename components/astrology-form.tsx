...
export function AstrologyForm() {
  ...
  // NOTE: UserQuery in types may allow nulls.
  // We still store strings here, but we null-proof when binding to inputs.
  const [query, setQuery] = useState<UserQuery>({
    question: "",
    birthDate: "",
    birthTime: "",
    birthPlace: "",
    // language optional; default handled in API route
  });
  ...
  // null->"" helper for controlled inputs
  const nn = (s: string | null | undefined) => s ?? "";
          ...
          <form onSubmit={handleAstroSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                required
                value={nn(query.question)}        // ✅ null-safe
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="date"
                  required
                  value={nn(query.birthDate)}      // ✅ null-safe
                  onChange={handleChange}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="time"
                  required
                  value={nn(query.birthTime)}      // ✅ null-safe
                  onChange={handleChange}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                value={nn(query.birthPlace)}       // ✅ null-safe
                onChange={handleChange}
              />
            </div>
