...
export function Chat({
  ...
  const {
    ...
    onFinish: async () => {
      ...
      try {
        ...
        setIsCoinSufficient(data.isCoinSufficient);
      } catch (err) {
  ...
  const [isCoinSufficient, setIsCoinSufficient] = useState(false);
    ...
    <>
      <div className="flex flex-col min-w-0 h-dvh bg-background">
        <ChatHeader
          ...
          isReadonly={(isReadonly || !isCoinSufficient)}
        />
        ...
        />
        {(upgradePrompt || isCoinSufficient) && (
          <div className="bg-red-500 text-white-800 p-4 rounded mb-4 text-center">
            {"You don't have enough coins. Purchase coins to continue."}
            <br />
